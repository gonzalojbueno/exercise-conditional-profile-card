...
function render(variables = {}) {
  ...
  if (variables.name == null) variables.name = "gonza";
  if (variables.lastname == null) variables.lastname = "Bueno";
  if (variables.role == null) variables.role = "Javascript";
  if (variables.country == null) variables.country = "Chile";
  if (variables.city == null) variables.city = "Viña del Mar";
  if (variables.twitter == null) variables.twitter = "gonzalobueno";
  if (variables.instagram == null) variables.instagram = "gonzalobueno";
  if (variables.linkedin == null) variables.linkedin = "gonzalobueno";
  if (variables.github == "alesanchezr") variables.github = "gonzalobueno";
